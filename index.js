const sessionName = "viana";
const donet = "dana : 083189250309";
const owner = ["6283189250309"]; // Put your number here ex: ["62xxxxxxxxx"]
const {
...
async function startHisoka() {
  ...
  client.ev.on("messages.upsert", async (chatUpdate) => {
    ...
    try {
      ...
      if (!m.isGroup && user.indexOf(m.sender) === -1 && !m.fromMe) {
        user.push(m.sender)
        m.reply("hallo pengguna baru.")
